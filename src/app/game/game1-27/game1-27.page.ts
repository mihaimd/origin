...
@Component({
  selector: 'app-game1-27',
  templateUrl: './game1-27.page.html',
  styleUrls: ['./game1-27.page.scss'],
  standalone: true,
...
export class Game127Page implements OnInit {
  ...
  selectOption(id: number) {
    ...
    goToNextStep() {
    console.log('next');
    this.router.navigate([`game${this.nextStep}-28`]);
  }
}
