...
@Component({
  selector: 'app-game1-26',
  templateUrl: './game1-26.page.html',
  styleUrls: ['./game1-26.page.scss'],
  standalone: true,
...
export class Game126Page implements OnInit {
  ...
  selectOption(id: number) {
    ...
    goToNextStep() {
    console.log('next');
    this.router.navigate([`game${this.nextStep}-27`]);
  }
}
