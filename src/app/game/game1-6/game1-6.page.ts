...
@Component({
  selector: 'app-game1-6',
  templateUrl: './game1-6.page.html',
  styleUrls: ['./game1-6.page.scss'],
  standalone: true,
...
export class Game16Page implements OnInit {
  ...
  selectOption(id: number) {
    ...
    goToNextStep() {
    console.log('next');
    this.router.navigate([`game${this.nextStep}-7`]);
  }
}
