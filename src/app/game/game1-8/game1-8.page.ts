...
@Component({
  selector: 'app-game1-8',
  templateUrl: './game1-8.page.html',
  styleUrls: ['./game1-8.page.scss'],
  standalone: true,
...
export class Game18Page implements OnInit {
  ...
  selectOption(id: number) {
    ...
    goToNextStep() {
    console.log('next');
    this.router.navigate([`game${this.nextStep}-9`]);
  }
}
