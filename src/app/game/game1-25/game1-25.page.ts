...
@Component({
  selector: 'app-game1-25',
  templateUrl: './game1-25.page.html',
  styleUrls: ['./game1-25.page.scss'],
  standalone: true,
...
export class Game125Page implements OnInit {
  ...
  selectOption(id: number) {
    ...
    goToNextStep() {
    console.log('next');
    this.router.navigate([`game${this.nextStep}-26`]);
  }
}
