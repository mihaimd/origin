...
@Component({
  selector: 'app-game1-16',
  templateUrl: './game1-16.page.html',
  styleUrls: ['./game1-16.page.scss'],
  standalone: true,
...
export class Game116Page implements OnInit {
  ...
  selectOption(id: number) {
    ...
    goToNextStep() {
    console.log('next');
    this.router.navigate([`game${this.nextStep}-17`]);
  }
}
