...
@Component({
  selector: 'app-game1-22',
  templateUrl: './game1-22.page.html',
  styleUrls: ['./game1-22.page.scss'],
  standalone: true,
...
export class Game122Page implements OnInit {
  ...
  selectOption(id: number) {
    ...
    goToNextStep() {
    console.log('next');
    this.router.navigate([`game${this.nextStep}-23`]);
  }
}
