...
@Component({
  selector: 'app-game1-5',
  templateUrl: './game1-5.page.html',
  styleUrls: ['./game1-5.page.scss'],
  standalone: true,
...
export class Game15Page implements OnInit {
  ...
  selectOption(id: number) {
    ...
    goToNextStep() {
    console.log('next');
    this.router.navigate([`game${this.nextStep}-6`]);
  }
