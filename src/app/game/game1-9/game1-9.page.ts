...
@Component({
  selector: 'app-game1-9',
  templateUrl: './game1-9.page.html',
  styleUrls: ['./game1-9.page.scss'],
  standalone: true,
...
export class Game19Page implements OnInit {
  ...
  selectOption(id: number) {
    ...
    goToNextStep() {
    console.log('next');
    this.router.navigate([`game${this.nextStep}-10`]);
  }
}
