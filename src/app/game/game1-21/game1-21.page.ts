...
@Component({
  selector: 'app-game1-21',
  templateUrl: './game1-21.page.html',
  styleUrls: ['./game1-21.page.scss'],
  standalone: true,
...
export class Game121Page implements OnInit {
  ...
  selectOption(id: number) {
    ...
    goToNextStep() {
    console.log('next');
    this.router.navigate([`game${this.nextStep}-22`]);
  }
}
