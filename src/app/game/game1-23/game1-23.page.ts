...
@Component({
  selector: 'app-game1-23',
  templateUrl: './game1-23.page.html',
  styleUrls: ['./game1-23.page.scss'],
  standalone: true,
...
export class Game123Page implements OnInit {
  ...
  selectOption(id: number) {
    ...
    goToNextStep() {
    console.log('next');
    this.router.navigate([`game${this.nextStep}-24`]);
  }
}
