...
@Component({
  selector: 'app-game1-11',
  templateUrl: './game1-11.page.html',
  styleUrls: ['./game1-11.page.scss'],
  standalone: true,
...
export class Game111Page implements OnInit {
  ...
  selectOption(id: number) {
    ...
    goToNextStep() {
    console.log('next');
    this.router.navigate([`game${this.nextStep}-12`]);
  }
}
