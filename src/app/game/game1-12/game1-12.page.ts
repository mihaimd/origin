...
@Component({
  selector: 'app-game1-12',
  templateUrl: './game1-12.page.html',
  styleUrls: ['./game1-12.page.scss'],
  standalone: true,
...
export class Game112Page implements OnInit {
  ...
  selectOption(id: number) {
    ...
    goToNextStep() {
    console.log('next');
    this.router.navigate([`game${this.nextStep}-13`]);
  }
}
