...
@Component({
  selector: 'app-game1-14',
  templateUrl: './game1-14.page.html',
  styleUrls: ['./game1-14.page.scss'],
  standalone: true,
...
export class Game114Page implements OnInit {
  ...
  selectOption(id: number) {
    ...
    goToNextStep() {
    console.log('next');
    this.router.navigate([`game${this.nextStep}-15`]);
  }
}
