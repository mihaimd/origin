...
@Component({
  selector: 'app-game1-7',
  templateUrl: './game1-7.page.html',
  styleUrls: ['./game1-7.page.scss'],
  standalone: true,
...
export class Game17Page implements OnInit {
  ...
  selectOption(id: number) {
    ...
    goToNextStep() {
    console.log('next');
    this.router.navigate([`game${this.nextStep}-8`]);
  }
}
