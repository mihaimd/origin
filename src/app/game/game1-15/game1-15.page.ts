...
@Component({
  selector: 'app-game1-15',
  templateUrl: './game1-15.page.html',
  styleUrls: ['./game1-15.page.scss'],
  standalone: true,
...
export class Game115Page implements OnInit {
  ...
  selectOption(id: number) {
    ...
    goToNextStep() {
    console.log('next');
    this.router.navigate([`game${this.nextStep}-16`]);
  }
}
