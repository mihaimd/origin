...
@Component({
  selector: 'app-game1-28',
  templateUrl: './game1-28.page.html',
  styleUrls: ['./game1-28.page.scss'],
  standalone: true,
...
export class Game128Page implements OnInit {
  ...
  selectOption(id: number) {
    ...
    goToNextStep() {
    console.log('next');
    this.router.navigate([`game${this.nextStep}-29`]);
  }
}
