...
@Component({
  selector: 'app-game1-18',
  templateUrl: './game1-18.page.html',
  styleUrls: ['./game1-18.page.scss'],
  standalone: true,
...
export class Game118Page implements OnInit {
  ...
  selectOption(id: number) {
    ...
    goToNextStep() {
    console.log('next');
    this.router.navigate([`game${this.nextStep}-19`]);
  }
}
