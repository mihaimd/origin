...
@Component({
  selector: 'app-game1-17',
  templateUrl: './game1-17.page.html',
  styleUrls: ['./game1-17.page.scss'],
  standalone: true,
...
export class Game117Page implements OnInit {
  ...
  selectOption(id: number) {
    ...
    goToNextStep() {
    console.log('next');
    this.router.navigate([`game${this.nextStep}-18`]);
  }
}
