...
@Component({
  selector: 'app-game1-20',
  templateUrl: './game1-20.page.html',
  styleUrls: ['./game1-20.page.scss'],
  standalone: true,
...
export class Game120Page implements OnInit {
  ...
  selectOption(id: number) {
    ...
    goToNextStep() {
    console.log('next');
    this.router.navigate([`game${this.nextStep}-21`]);
  }
}
