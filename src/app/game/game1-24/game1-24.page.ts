...
@Component({
  selector: 'app-game1-24',
  templateUrl: './game1-24.page.html',
  styleUrls: ['./game1-24.page.scss'],
  standalone: true,
...
export class Game124Page implements OnInit {
  ...
  selectOption(id: number) {
    ...
    goToNextStep() {
    console.log('next');
    this.router.navigate([`game${this.nextStep}-25`]);
  }
}
