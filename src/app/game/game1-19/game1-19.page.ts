...
@Component({
  selector: 'app-game1-19',
  templateUrl: './game1-19.page.html',
  styleUrls: ['./game1-19.page.scss'],
  standalone: true,
...
export class Game119Page implements OnInit {
  ...
  selectOption(id: number) {
    ...
    goToNextStep() {
    console.log('next');
    this.router.navigate([`game${this.nextStep}-20`]);
  }
}
