...
@Component({
  selector: 'app-game1-10',
  templateUrl: './game1-10.page.html',
  styleUrls: ['./game1-10.page.scss'],
  standalone: true,
...
export class Game110Page implements OnInit {
  ...
  selectOption(id: number) {
    ...
    goToNextStep() {
    console.log('next');
    this.router.navigate([`game${this.nextStep}-11`]);
  }
}
