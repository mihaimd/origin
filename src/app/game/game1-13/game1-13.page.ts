...
@Component({
  selector: 'app-game1-13',
  templateUrl: './game1-13.page.html',
  styleUrls: ['./game1-13.page.scss'],
  standalone: true,
...
export class Game113Page implements OnInit {
  ...
  selectOption(id: number) {
    ...
    goToNextStep() {
    console.log('next');
    this.router.navigate([`game${this.nextStep}-14`]);
  }
}
