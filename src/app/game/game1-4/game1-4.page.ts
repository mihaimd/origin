...
@Component({
  selector: 'app-game1-4',
  templateUrl: './game1-4.page.html',
  styleUrls: ['./game1-4.page.scss'],
  standalone: true,
...
export class Game14Page implements OnInit {
  ...
  selectOption(id: number) {
    ...
    goToNextStep() {
    console.log('next');
    this.router.navigate([`game${this.nextStep}-5`]);
  }
}
