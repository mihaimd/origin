...
@Component({
  selector: 'app-game1-29',
  templateUrl: './game1-29.page.html',
  styleUrls: ['./game1-29.page.scss'],
  standalone: true,
...
export class Game129Page implements OnInit {
  ...
  selectOption(id: number) {
    ...
    goToNextStep() {
    console.log('next');
    this.router.navigate([`game${this.nextStep}-30`]);
  }
}
